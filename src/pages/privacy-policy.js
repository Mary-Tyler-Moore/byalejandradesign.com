  ...
  render() {
    return (
      <Layout>
        ...
        <p>
          Archetexture LLC ("us", "we", or "our") operates the
          https://artetexture.com website (the "Service").
        </p>
        ...
        <p>
          ...
          Archetexture LLC is powered by{' '}
          <a href="https://freeprivacypolicy.com/" target="__blank">
        ...
        <p>
          ...
          our Terms and Conditions, accessible from https://artetexture.com
        </p>
        ...
        <p>Archetexture LLC uses the collected data for various purposes:</p>
        <ul>
        ...
        <p>
          Archetexture LLC may disclose your Personal Data in the good faith
        ...
        <ul>
          <li>By email: alejandra@artetexture.com</li>
          <li>
            By visiting this page on our website:
            https://artetexture.com/contact
          </li>

          <li>By mail: Archetexture LLC</li>
        </ul>
      </Layout>
    );
  }
