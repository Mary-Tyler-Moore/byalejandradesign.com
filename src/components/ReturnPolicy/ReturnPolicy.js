...
const ReturnPolicy = () => (
  <section>
    ...
    <p>
      ...
      will send you an email to notify you that we have received your returned
    ...
    <p>
      ...
      yet, first check your bank account again. Then contact your credit card
      ...
      received your refund yet, please contact us at alejandra@artetexture.com.
    </p>
    ...
    <p>
      ...
      damaged. If you need to exchange it for the same item, send us an email at
      alejandra@artetexture.com and send your item to: 1678 1st Ave. Apt. 2N,
      New York, NY, 10128, United States.
    </p>

    <p>
      Gifts If the item was marked as a gift when purchased and shipped directly
    ...
    <p>
      Shipping To return your product, you should mail your product to: 1678 1st
      Ave. Apt. 2N, New York, NY, 10128, United States.
    </p>
