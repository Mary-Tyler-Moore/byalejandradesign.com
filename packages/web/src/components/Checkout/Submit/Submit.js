          ...
          {this.props.cart.products.length > 0 ? (
            <React.Fragment>
              ...
              <section className="orderSubmit_addressSection">
                <h4 className="h4-headline">Address</h4>
              ...
              <section className="orderSubmit_paymentSection">
                <h4 className="h4-headline">Payment Details</h4>
                <p>
